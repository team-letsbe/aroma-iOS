...
""")
        ...
        $0.font = .gmarket(size: 18, family: .bold)
    }
    ...
    override func addViews() {
        view.addSubviews(detailScrollView, speakerButton, lineView)
    ...
    override func setLayout() {
        ...
        lineView.snp.makeConstraints {
            $0.top.equalTo(detailScrollView.snp.bottom).offset(5)
            $0.height.equalTo(1)
            $0.width.equalTo(358)
        ...
        detailTextView.snp.makeConstraints {
            ...
            $0.leading.trailing.equalTo(detailScrollView.safeAreaLayoutGuide).inset(2)
